...
{
    public class MaterialExpressionCrossProductConverter : GenericConverter<MaterialExpressionCrossProduct>
    {
        public override bool CanConvert(MaterialNode unrealNode)
        {
            return unrealNode is MaterialExpressionCrossProduct;
        }

        protected override SurfaceNode CreateNode(MaterialConverter converter, MaterialExpressionCrossProduct unrealNode)
        {
        ...
        public override void CreateConnections(MaterialExpressionCrossProduct unrealNode, Material unrealMaterial, MaterialConverter builder)
        {
